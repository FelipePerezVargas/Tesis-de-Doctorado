...
DEM <- raster("/Users/User/Desktop/Yuriria-NAME/NEON-DS-Field-Site-Spatial-Data/SJER/DigitalTerrainModel/SJER2013_DTM.tif")  
...
image(DEM, zlim=c(250,385), main="Digital Elevation Model (DEM)", col=col)
...
brk <- c(250, 300, 350, 400,450,500,550)
