...
hmf <- ggplot(hplc, aes(x=co, y=hmf5)) + geom_point(color="red",fill="blue",shape=21,alpha=0.5,size=4,stroke = 2) +
  geom_smooth(method=lm, col="springgreen4") +
  ggtitle("Curva de calibración 5 Hidroximetil Furfural ", subtitle="Cromatografía de Líquidos de Alta Resolución HPLC") +
