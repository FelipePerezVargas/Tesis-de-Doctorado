...
ylabel('Absortividad molar')                                             %%  
title('Furfural')                                                        %%
legend('Coeficiente de absorción Fur')                                   %%
axis ([ 250 325 0 190 ])                                                 %% 
...
%epA1=(Co'*Co)^-1*A(:,2:end)*Co;                                         %%
C5hmf=plot(C(:,1),epC,'b');                                              %%
xlabel('Longitud de onda (nm)')                                          %%
ylabel('Absortividad molar')                                             %%  
title('5 Hidroximetil Furfural')                                         %%
legend('Coeficiente de absorción 5HMF')                                  %%
axis ([ 250 325 0 190 ])                                                 %% 
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%                Máximos  del Coeficiente de Absorción                   %%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%                                                                        %%
%                                                                        %%
nA=find(epA==max(epA));                                                  %%
...
TO=plot(A(:,1),epA,'r',A(:,1),epB,'g',A(:,1),epC,'b',A(:,1),epD,'k');
xlabel('Longitud de onda (nm)')
ylabel('Absorbancia (ua)')
...
% XXX=T(:,1)
% XT=[epA epB epC epD]
% lm = fitlm(XT,YT,'linear')
% [XL,yl,XS,YS,beta,PCTVAR] = plsregress(XT,YT,4)
% b = robustfit(XT,YT)
%mdl = stepwiselm(XT,YT,'linear')
%epT=epA*0.00019545 +epB*0.0036734+epC*0.00084632 +epD*0.00013122;
%TT=plot(T(:,1),YT,'y',T(:,1),epT,'r--',...
%    T(:,1),epA*0.0010669,'r',T(:,1),epB*0.0010181,'g',...
%    T(:,1),epC*-0.0016289 ,'b',T(:,1),epD*-0.0043212,'k');
%xlabel('Longitud de onda (nm)')
%ylabel('Absorbancia (ua)')
%title('Coeficientes de absorción')
%legend('Tequila','Todos','2AF','5HMF', 'FUR','5MF')
