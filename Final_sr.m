...
figure                                                                   %%
subplot(1,2,1)                                                           %% 
P2=plot(B(:,1),B(:,2),'b',B(:,1),B(:,3),'b',...                  %%
    B(:,1),B(:,4),'b', B(:,1),B(:,5),'b',...                     %%
    B(:,1),B(:,6),'b',B(:,1),B(:,7),'b',...                      %%
    B(:,1),B(:,8),'b',B(:,1),B(:,9),'b',...                      %%
    B(:,1),B(:,10),'b',B(:,1),B(:,11),'b');                      %%  
 xlabel('Longitud de onda (nm)')                                         %%
 ylabel('Absorbancia (ua)')                                              %%
 legend('Furfural');                                                     %%
 title('Furural')                                                        %%
...
figure                                                                   %%
subplot(1,2,1)                                                           %% 
P3=plot(C(:,1),C(:,2),'b',C(:,1),C(:,3),'b',...                  %%
    C(:,1),C(:,4),'b', C(:,1),C(:,5),'b',...                     %%
    C(:,1),C(:,6),'b',C(:,1),C(:,7),'b',...                      %%
    C(:,1),C(:,8),'b',C(:,1),C(:,9),'b',...                      %%
    C(:,1),C(:,10),'b',C(:,1),C(:,11),'b');                      %%  
 xlabel('Longitud de onda (nm)')                                         %%
 ylabel('Absorbancia (ua)')                                              %%
...
%figure 
 ...
 xlabel('Longitud de onda (nm)')
 ylabel('Absorbancia (ua)')
 legend('Tequila','Ajuste','5MF','FUR', '5HMF','2AF')
